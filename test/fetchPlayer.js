...
client.fetchPlayer("1s3k3b").then(d => console.log(d, d.raw)); // fetch methods return a Promise as it takes time for the socket to load data, you need to wait for it to resolve in order to work
